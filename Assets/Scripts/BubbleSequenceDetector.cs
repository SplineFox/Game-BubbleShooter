...
{
    public class BubbleSequenceDetector
    {
        ...
        public BubbleSequenceDetector(HexGrid hexGrid)
        {
            _hexGrid = hexGrid;
            _visitedPoints = new();
            _searchPoints = new();
        ...
        public bool TryGetSequence(HexPoint hexPoint, out IEnumerable<(HexPoint, Bubble)> sequence)
        {
